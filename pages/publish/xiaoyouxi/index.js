...
Page({
	onShareAppMessage: function (res) {
		return {
			title: '爱店(爱小程序商店)邀请您来发布您的微信小游戏,让更多人看到哦',
			success: (res) => {
				wx.showToast({
					content: '分享成功'
				})
	...
	onLoad: function (options) {
		...
		// 获取栏目
		wx.request({
			url: 'https://www.yishuzi.com.cn/shop_xiaochengxu_api/?getJson=class&classid=8&publish=1',
	...
	bindPickerChange: function (e) {
		...
		getApp().globalData.globalXiaoyouxiClassIndex = e.detail.value;
	},
